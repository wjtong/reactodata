...
public interface EntityService {
    ...
    List<QuarkEntity> findRelatedEntity(QuarkEntity entity, Map<String, String> mappedProperties, Map<String, QueryOption> queryOptions) throws ODataApplicationException;
